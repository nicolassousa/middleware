                        ...
                        if (res.statusCode == 200) {
                            if (res.body.length == 0) {
                                ...
                                jasminAux.insertClient(email, access_token, (res) => {
                                    if (res.statusCode == 200) {                                        
                                        jasminAux.checkUser(email, access_token, (res1) => {
                                                ...
                                                if (res1.body.length == 0) {
                                                    ...
                                                    if(productSold.length != 0){
                                                        let json = {
                                                            ...
                                                            'buyerCustomerParty': user1.partyKey, //ID do cliente que realiza a compra
                                                            'buyerCustomerPartyName': user1.name, //Nome do Cliente
                                                            'buyerCustomerPartyTaxId': user1.companyTaxID, //NIF do cliente
                                                            'exchangeRate': 1,
