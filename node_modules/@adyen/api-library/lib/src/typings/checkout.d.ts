declare namespace ICheckout {
    ...
    interface BillDeskOnlineDetails {
        /**
    ...
    interface BillDeskWalletDetails {
        /**
         * The issuer id of the shopper's selected bank.
         */
        issuer: string;
    ...
    interface CheckoutBalanceCheckRequest {
        /**
    ...
    interface CheckoutBalanceCheckResponse {
        /**
    ...
    interface CheckoutCancelOrderRequest {
        /**
    ...
    interface CheckoutCancelOrderResponse {
        /**
    ...
    interface CheckoutCreateOrderRequest {
        /**
    ...
    interface CheckoutCreateOrderResponse {
        /**
         * This field contains additional data, which may be required to return in a particular payment response. To choose data fields to be returned, go to **Customer Area** > **Account** > **API URLs** > **Additional data settings**.
         */
        additionalData?: /* This field contains additional data, which may be required to return in a particular payment response. To choose data fields to be returned, go to **Customer Area** > **Account** > **API URLs** > **Additional data settings**. */ ResponseAdditionalDataCommon | ResponseAdditionalDataBillingAddress | ResponseAdditionalDataCard | ResponseAdditionalDataDeliveryAddress | ResponseAdditionalDataInstallments | ResponseAdditionalDataNetworkTokens | ResponseAdditionalDataPayPal | ResponseAdditionalDataSepa;
    ...
    interface CheckoutDonationAction {
        /**
         * When non-empty, contains a value that you must submit to the `/payments/details` endpoint. In some cases, required for polling.
         */
        paymentData?: string;
    ...
    interface CheckoutOneTimePasscodeAction {
        /**
         * When non-empty, contains a value that you must submit to the `/payments/details` endpoint. In some cases, required for polling.
         */
        paymentData?: string;
    ...
    interface CheckoutQrCodeAction {
        /**
         * When non-empty, contains a value that you must submit to the `/payments/details` endpoint. In some cases, required for polling.
         */
        paymentData?: string;
    ...
    interface CheckoutThreeDS2ChallengeAction {
        /**
         * When non-empty, contains a value that you must submit to the `/payments/details` endpoint. In some cases, required for polling.
         */
        paymentData?: string;
    ...
    interface CheckoutThreeDS2FingerPrintAction {
        /**
         * When non-empty, contains a value that you must submit to the `/payments/details` endpoint. In some cases, required for polling.
         */
        paymentData?: string;
    ...
    interface CheckoutVoucherAction {
        /**
    ...
    interface EcontextVoucherDetails {
        /**
         * The shopper's first name.
         */
        firstName: string;
    ...
    interface MobilePayDetails {
        /**
         * **mobilepay**
         */
        type: string;
    }
    interface MolPayDetails {
        /**
         *
         */
        issuer: string;
    ...
    interface SepaDirectDebitDetails {
        /**
    ...
    interface StoredPaymentMethodDetails {
        /**
         * This is the `recurringDetailReference` returned in the response when you created the token.
         */
        storedPaymentMethodId?: string;
    ...
    interface WeChatPayMiniProgramDetails {
        appId?: string;
        openid?: string;
        /**
...
declare namespace Paths {
    namespace GetPaymentLinksLinkId {
        ...
        namespace Responses {
            type $200 = ICheckout.PaymentLinkResource;
            interface $400 {
            }
            interface $401 {
            }
    ...
    namespace PatchPaymentLinksLinkId {
        ...
        type RequestBody = ICheckout.UpdatePaymentLinkRequest;
        namespace Responses {
            type $200 = ICheckout.PaymentLinkResource;
            interface $400 {
            }
    ...
    namespace PostOrders {
        type RequestBody = ICheckout.CheckoutCreateOrderRequest;
        namespace Responses {
            type $200 = ICheckout.CheckoutCreateOrderResponse;
            interface $400 {
            }
            interface $401 {
            }
    ...
    namespace PostOrdersCancel {
        type RequestBody = ICheckout.CheckoutCancelOrderRequest;
        namespace Responses {
            type $200 = ICheckout.CheckoutCancelOrderResponse;
            interface $400 {
            }
            interface $401 {
            }
    ...
    namespace PostOriginKeys {
        type RequestBody = ICheckout.CheckoutUtilityRequest;
        namespace Responses {
            type $200 = ICheckout.CheckoutUtilityResponse;
            interface $400 {
            }
            interface $401 {
            }
    ...
    namespace PostPaymentLinks {
        type RequestBody = ICheckout.CreatePaymentLinkRequest;
        namespace Responses {
            type $200 = ICheckout.PaymentLinkResource;
            interface $201 {
            }
    ...
    namespace PostPaymentMethods {
        type RequestBody = ICheckout.PaymentMethodsRequest;
        namespace Responses {
            type $200 = ICheckout.PaymentMethodsResponse;
            interface $400 {
            }
            interface $401 {
            }
    ...
    namespace PostPaymentMethodsBalance {
        type RequestBody = ICheckout.CheckoutBalanceCheckRequest;
        namespace Responses {
            type $200 = ICheckout.CheckoutBalanceCheckResponse;
            interface $400 {
            }
            interface $401 {
            }
    ...
    namespace PostPaymentSession {
        type RequestBody = ICheckout.PaymentSetupRequest;
        namespace Responses {
            type $200 = ICheckout.PaymentSetupResponse;
            interface $400 {
            }
            interface $401 {
            }
    ...
    namespace PostPayments {
        type RequestBody = ICheckout.PaymentRequest;
        namespace Responses {
            type $200 = ICheckout.PaymentResponse;
            interface $400 {
            }
            interface $401 {
            }
    ...
    namespace PostPaymentsDetails {
        type RequestBody = ICheckout.DetailsRequest;
        namespace Responses {
            type $200 = ICheckout.PaymentResponse;
            interface $400 {
            }
